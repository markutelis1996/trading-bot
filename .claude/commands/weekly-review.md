---
description: Run the Friday weekly review workflow locally. Reads .env for credentials.
---

You are running the Friday weekly review workflow locally. Resolve today's date via: DATE=$(date +%Y-%m-%d).

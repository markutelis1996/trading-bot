---
description: Run the midday scan workflow locally. Reads .env for credentials.
---

You are running the midday scan workflow locally. Resolve today's date via: DATE=$(date +%Y-%m-%d).

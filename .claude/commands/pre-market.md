---
description: Run the pre-market research workflow locally. Reads .env for credentials.
---

You are running the pre-market research workflow locally. Resolve today's date via: DATE=$(date +%Y-%m-%d).

Credentials come from the local .env file (wrapper scripts source it automatically).

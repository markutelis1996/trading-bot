---
description: Run the daily summary workflow locally. Reads .env for credentials.
---

You are running the daily summary workflow locally. Resolve today's date via: DATE=$(date +%Y-%m-%d).
